...
function Interface:createInterface()
    ...
    local leftWindowTextCamPos = 			  Text(Coordinate2D(0,0), "Cam pos", 			leftWindowMain, Coordinate2D(GlobalConstants.LEFT_WINDOW_WIDTH/2,40), nil, 1.4, "left")
    local leftWindowTextCamLook = 		  Text(Coordinate2D(0,40), "Cam look", 		leftWindowMain, Coordinate2D(GlobalConstants.LEFT_WINDOW_WIDTH/2,40), nil, 1.4, "left")
    local leftWindowTextEffStatic = 		Text(Coordinate2D(0,80), "Effect static", 	leftWindowMain, Coordinate2D(GlobalConstants.LEFT_WINDOW_WIDTH/2,40), nil, 1.4, "left")
    local leftWindowTextEffDynamic = 		Text(Coordinate2D(0,120), "Effect dynamic", leftWindowMain, Coordinate2D(GlobalConstants.LEFT_WINDOW_WIDTH/2,40), nil, 1.4, "left")
